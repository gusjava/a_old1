package a.entity.gus.b.entitysrc2.database.entity_link.find1;
...
public class EntityImpl implements Entity, T {
	...
	public Object t(Object obj) throws Exception
	{
		...
		String sql = "SELECT "+COL_NAME2+" FROM "+TABLENAME+" WHERE "+COL_NAME1+"=?";
		...
		while(rs.next())
		{
			String link = (String) rs.getObject(COL_NAME2);
			data.add(link);
		}
		st.close();
		return data;
